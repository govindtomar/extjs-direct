...
use GT\ExtDirect\Router\Event\BeginRequestEvent;
use GT\ExtDirect\Router\Event\EndRequestEvent;
use GT\ExtDirect\Router\Event\Event;
use GT\ExtDirect\Router\Event\ExceptionEvent;
