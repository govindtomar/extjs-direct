...
class RequestFactoryTest extends TestCase
{
    public function testCreateJsonRequest()
    {
        ...
        $this->assertInstanceOf('GT\ExtDirect\Router\RequestCollection', $directRequest);
        ...
        $this->assertInstanceOf('GT\ExtDirect\Router\Request', $firstRequest);
    ...
    public function testCreateJsonRequestFromMalformedJsonStringFails()
    {
        ...
        $this->expectException('GT\ExtDirect\Router\Exception\BadRequestException');
    ...
    public function testCreateJsonRequestFromInvalidExtDirectJsonStringFails()
    {
        ...
        $this->expectException(
            'GT\ExtDirect\Router\Exception\BadRequestException'
        );
