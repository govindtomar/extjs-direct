...
use GT\ExtDirect\Router\ArgumentValidator;
...
class ArgumentValidatorTest extends TestCase
{
    ...
    public function testParameterWithoutConstraintsIsNotValidatedAndFailsInStrictMode()
    {
        ...
        $this->expectException(
            'GT\ExtDirect\Router\Exception\StrictArgumentValidationException'
        );
    ...
    public function testValidatorFailsWhenValidationFails()
    {
        ...
        $this->expectException(
            'GT\ExtDirect\Router\Exception\ArgumentValidationException'
        );
        $this->expectExceptionMessage(
    ...
    public function testStrictParameterConstraintAreValidated()
    {
        ...
        try {
            ...
            $this->fail('Expected GT\ExtDirect\Router\Exception\ArgumentValidationException not called');
